...
export function pickTable(val){if(S.pendingStaffOrder)return;const inp=document.getElementById('inpTable');if(inp){inp.value=val;inp.dispatchEvent(new Event('input',{bubbles:true}));}buildQuickTableBtns();}
